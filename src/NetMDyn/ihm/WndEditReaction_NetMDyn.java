...
public class WndEditReaction_NetMDyn extends javax.swing.JDialog {
    ...
    private final ArrayList<Behavior_NetMDyn> lstCmpt;
     ...
     * @param behaviours
     */
    public WndEditReaction_NetMDyn(ArrayList<Entity_NetMDyn> entities, ArrayList<Behavior_NetMDyn> behaviours, ArrayList<Compartment> compartment) {
        this.setModal(true);
        lstCmpt=behaviours;
    ...
    public void WndCliEditReaction3_Load(Behavior_NetMDyn behaviour) {
        if(behaviour == null){
    ...
    public void button_OKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_validerMouseClicked
        ...
        for (Behavior_NetMDyn lstCmpt1 : lstCmpt) {
